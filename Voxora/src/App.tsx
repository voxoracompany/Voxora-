  ...
  return (
    <div className="voxora">
      ...
      <nav className="navbar">
        ...
        <button className="launch-btn" onClick={() => setShowDashboard(true)}>
          Launch App →
        </button>
      </nav>
      ...
      <main className="hero">
        <div className="hero-content">
          ...
          <div className="buttons">
            <button className="primary" onClick={() => setShowDashboard(true)}>
              Start Building Free →
            </button>
            <button className="secondary" onClick={() => setShowDashboard(true)}>
      ...
      <section className="ecosystem" id="features">
        ...
        <div className="agent-grid">
          {[
            ...
            <div key={a.title} className="agent-card">
      ...
      <footer className="footer">
        <div className="footer-inner">
          <div className="footer-brand">
            ...
            <button className="launch-btn footer-launch" onClick={() => setShowDashboard(true)}>
              Launch App →
            </button>
          </div>
        ...
        <div className="footer-bottom">
          <span>© 2026 Voxora. All rights reserved.</span>
